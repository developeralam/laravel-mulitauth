                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="top-right text-right">
                            <ul class="list-unstyled list-inline">
                                ...
                                @guest
                                <li class="list-inline-item"><a href="{{route('login')}}"><img src="images/login.png" alt="">Login</a></li>
                                @if(Route::has('register'))
                                <li class="list-inline-item"><a href="{{route('register')}}"><img src="images/login.png" alt="">{{__('Register')}}</a></li>
                                @endif
                                @else
